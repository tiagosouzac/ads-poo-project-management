...
import br.edu.iftm.actions.tasks.UpdateProjectTask;
...
public class ProjectTasksDetailsMenu extends Menu {
    ...
    public void display() {
        while (true) {
            ...
            System.out.println("2. Atualizar a tarefa");
            System.out.println("3. Ver os comentários da tarefa");
            ...
            switch (selectedOption) {
                ...
                case 2:
                    new UpdateProjectTask(project, task).update();
                    break;
